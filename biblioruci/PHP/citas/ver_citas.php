...
<body>
    ...
    <table id="resultado" align="center" border="1" id="tabla_consultas"> <!-- Tabla con los resultados de la consulta -->
        ...
        <?php
            $citas = "SELECT * FROM citas ORDER BY fecha_hora_cita ASC";
        ...
        <?php
            ...
            if(isset($_POST["cancelar_cita"]) != "" && $consulta_id_cita){
                ...
                $cancelar = sprintf("DELETE FROM citas WHERE id_cita = '$id_cita'");

                //comprobar que el usuario que quiere cancelar la cita es bibliotecario o administrador
                if($contador2 == 1 or $contador3 == 1){
                    //comprobar que la cita se ha solicitado y no se ha cancelado anteriormente
                    if("SELECT id_cita FROM citas WHERE id_cita = $id_cita" != ""){
