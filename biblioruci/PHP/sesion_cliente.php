...
<?php
    ...
    $consulta_categoria = "SELECT * FROM socios WHERE categoria = 'cliente' AND correo_electronico = '$correo_electronico'";

    //si consulta_categoria está vacío, el usuario no es cliente
    if(!$consulta_categoria){
        //expulsar al usuario si no es cliente
        session_abort();
        header("Location: ../index.html"); //expulsar al usuario si no es cliente
    }
?>
    ...
    <div class="consulta_de_fondos" style="margin-top: 10px;">
        ...
        <table align="center">
            ...
            <tr>
                ...
                <td><a href="citas/ver_citas_cliente.php">Ver citas<!--Sólo citas del cliente--></a></td>
            </tr>
        </table>
    </div>

    <div class="informacion_libros">
        <h2><b>Información sobre los libros:</b></h2>
        <table align="center">
            <tr>
